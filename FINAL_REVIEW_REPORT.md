...
| 命令 | 功能 | 状态 |
|------|------|------|
| `opspulse templates list` | 列出所有模板 | ✅ 已完成 |
| `opspulse templates show <name>` | 查看模板详情 | ✅ 已完成 |
| `opspulse project init` | 扫描项目生成配置 | ✅ 已完成 |
| `opspulse handle --template <name>` | 按模板处理 Issue | ✅ 已完成 |
