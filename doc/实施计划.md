...
- [x] `git push` 成功，GitHub 上 Issue 模板可选
- [x] `validate-schema.yml` CI 绿
- [x] 3 个 `examples/issues/` 全部通过 Schema 校验
- [x] `local-runner/run-pipeline.sh` 可执行（Docker 阶段已实跑）
...
- [x] `scripts/e2e-demo.sh` 退出码 0
- [ ] TTFV < 30min（第三人按 quickstart 实测）
- [ ] `mcp-server/tests/` 覆盖率 ≥ 60%
- [x] 更新 CHANGELOG `v0.1.0-demo`
...
### Phase 2
- [x] parse_issue
- [x] update_issue_status
- [x] trigger_pipeline
- [x] local-runner 5 阶段
- [x] e2e-demo.sh
- [x] quickstart.md
- [x] Gate 2 / v0.1.0-demo
